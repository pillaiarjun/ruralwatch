...
|--------|-----------------|
| CMS Hospital Provider Cost Report | Annual financial filings for every Medicare-certified US hospital (2011-2022) |
| USDA Rural-Urban Continuum Codes | County-level rurality scores (1 = metro, 9 = most rural) |
| UNC Sheps Center Closure Registry | Ground-truth labels: every rural hospital closure since 2005 |
...
**3-year closure window:** 1 year provides insufficient lead time for intervention. 5 years introduces closures caused by factors (e.g. COVID) that did not exist at prediction time. 3 years reflects published rural hospital distress literature.
...
**Star schema in Gold layer:** The Medallion architecture describes data quality stages. The star schema organizes the Gold layer for efficient analytical querying, with a fact table in the center and dimension tables (hospital, geography, time, payer) radiating outward.
